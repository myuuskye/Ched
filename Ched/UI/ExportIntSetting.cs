...
namespace Ched.Core
{
    public class ExportIntSetting : IExportSetting
    {
        ...
        public SettingTypes Type { get; set; } = SettingTypes.i;
        ...
        public ExportIntSetting(int id, int value, string title, string description, int @default, SettingTypes type, List<string> choices, int min, int max, string category = "Other", int category2 = 0, string cate2name = "", Image cate2image = null, int category3 = 0, string cate3name = "", Image cate3image = null) { 
            Title = title;
            ID = id;
        ...
        public ExportIntSetting(ExportIntSetting setting)
        {
            Title = setting.Title;
            ID = setting.ID;
